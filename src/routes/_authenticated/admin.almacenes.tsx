          ...
          <div className="max-h-[500px] overflow-y-auto">
            <Table>
              ...
              <TableBody>
                ...
                {stock.map((s) => {
                  const low =
                    s.product?.min_stock != null &&
                    Number(s.quantity) <= Number(s.product.min_stock);
                  return (
                    <TableRow key={s.id}>
                      ...
                      <TableCell
                        className={`text-right tabular-nums ${low ? "text-rose-700 font-medium" : ""}`}
                      >
