...
function MaterialsPage() {
  ...
  async function refresh() {
    setRows(await list({ data: { type: "material" } }));
  }
  useEffect(() => {
    refresh();
  ...
  return (
    <div>
      ...
      <FormDialog
        ...
        title={dlg.data ? "Editar material" : "Nuevo material"}
        onSubmit={onSubmit}
        submitting={saving}
      >
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <Button
              ...
              onClick={() =>
                setPres((p) => [
                  ...p,
                  { unit: "unidad", price: 0, units_in_presentation: 1, label: "" },
                ])
              }
            >
