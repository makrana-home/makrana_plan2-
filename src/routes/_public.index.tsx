  ...
  return (
    <>
      <section className="relative isolate min-h-[100svh] overflow-hidden bg-primary">
        ...
        <div className="container-makrana relative z-10 flex min-h-[100svh] flex-col items-center justify-end pb-14 text-center md:pb-20">
          <h1 className="sr-only">Makrana Home Art</h1>
        </div>
      </section>
        ...
        <div className="container-makrana grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-3">
              <FeaturePill label="Tejido artesanal" />
              <FeaturePill label="Algodón natural" />
              <FeaturePill label="Piezas únicas" />
            </div>
            <div className="mt-6">
              <Button asChild size="lg" variant="hero" className="h-12 rounded-full px-7">
                <a
                  href="https://wa.me/51986608552?text=Hola%20Makrana%2C%20quiero%20hacer%20un%20pedido%20personalizado."
                  target="_blank"
                  rel="noreferrer"
                >
      ...
      <section className="section-padded bg-warm-white">
        <div className="container-makrana">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {featured.length > 0
              ? featured.map((p) => (
                  <ProductCard key={p.id} product={p as any} showPrice={false} />
                ))
...
function FeaturePill({ label }: { label: string }) {
  return (
    <div className="flex min-h-20 items-center justify-center rounded-2xl border border-sand/70 bg-card p-4 text-center shadow-sm">
