...
function Home_() {
  ...
  const EditorialImage = ({
    ...
    const ratio = index === 1 ? "aspect-[4/5]" : index === 2 ? "aspect-[4/3]" : "aspect-[5/4]";
        ...
        <section className="relative isolate min-h-[100svh] overflow-hidden bg-primary">
          <div className="absolute inset-0 -z-10" aria-hidden="true">
            ...
            >
              ...
              />
              <source src="/portada-makrana.mp4" type="video/mp4" media="(min-width: 768px)" />
            </video>
          </div>
                  ...
                  <div className="flex min-h-24 items-center justify-between gap-4 px-5 py-4">
                    <div>
                      ...
                      <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                        {category.home_description ||
                          "Piezas artesanales para transformar tu espacio."}
                      </p>
                    </div>
                    <ArrowRight
      ...
      {homeSections.news && (
        <section className="border-y border-sand/60 bg-sand/45">
          <div className="container-makrana py-24 md:py-28">
            <div>
              <div className="text-[11px] uppercase tracking-[0.22em] text-brand-terracotta">
                Novedades
              </div>
