  ...
  return (
    <section className="section-padded">
      <div className="container-makrana max-w-3xl">
        ...
        <p className="mt-3 text-muted-foreground">Cuéntanos qué buscas y conversemos. Estamos en Lima, Perú.</p>

        <div className="grid sm:grid-cols-3 gap-6 mt-10">
          <a href="https://wa.me/51999999999" target="_blank" rel="noreferrer" className="makrana-card p-6 text-center">
        ...
        <div className="mt-10">
          <Button asChild size="lg" variant="hero">
            <a href="https://wa.me/51999999999" target="_blank" rel="noreferrer">Escribir por WhatsApp</a>
          </Button>
        </div>
      </div>
    </section>
