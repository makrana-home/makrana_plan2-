  ...
  head: () => ({
    meta: [
      { title: "Registro · Makrana Home Art" },
      {
        name: "description",
        content:
          "Déjanos tus datos y descubre lo nuevo de Makrana: productos, talleres y novedades.",
      },
    ...
    <section className="section-padded">
      <div className="container-makrana max-w-2xl">
        ...
        <p className="mt-3 text-muted-foreground">
          Déjanos tus datos para enviarte novedades, talleres y piezas nuevas.
        </p>
        ...
        <form onSubmit={onSubmit} className="mt-8 grid gap-4">
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="location" name="location" maxLength={160} placeholder="Lima, Perú" />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                name="interest"
                maxLength={160}
                placeholder="Productos, talleres, materiales..."
              />
            </div>
          </div>
          <div className="grid gap-2">
