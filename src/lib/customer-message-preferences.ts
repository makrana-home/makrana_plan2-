...
import { defaultCustomerMessage, legacyCustomerMessage } from "@/lib/customer-message";
...
export async function getCustomerMessage() {
  ...
  return saved.success && saved.data !== legacyCustomerMessage ? saved.data : defaultCustomerMessage;
}
